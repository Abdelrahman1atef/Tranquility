  ...
  Widget build(BuildContext context) {
    ...
    "So why wait? Take a deep breath, download Tranquility, and let our AI chatbot guide you on your path to inner peace and tranquility. Together, we can create a brighter, calmer future – one conversation at a time.",
     ...
     return Scaffold(
      ...
      appBar: const CustomAppBar(haveTitle: true, haveSearchBar: false,title: "About Us",),
        ...
        child: Column(
          ...
          children: [
            const Row(
              ...
              children: [AppImage(image: "app_image.png", width: 250)],
            ),
            ...
            Padding(
              ...
              child: Column(
                spacing: 16,
                children: texts.map((text)=>AppText(text,style: theme.textTheme.labelSmall,)).toList(),
              ),
            )
          ],
        ),
